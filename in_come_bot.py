...
content = (
    ...
    "            buttons = [\n"
    "                [InlineKeyboardButton(f'{h}\uc2dc', callback_data=f'start_{h}') for h in range(7,11)],\n"
    "                [InlineKeyboardButton(f'{h}\uc2dc', callback_data=f'start_{h}') for h in range(11,16)],\n"
    "                [InlineKeyboardButton('\ud734\ubb34 (\ubaa8\ub4e0 \uc785\ub825 \uac74\ub108\ub044\uae30)', callback_data='start_off')],\n"
    "            ]\n"
    "            await update.message.reply_text('\uadfc\ubb34 \uc2dc\uc791 \uc2dc\uac01 \uc120\ud0dd (1\ud68c\ucc28: 7\uc2dc~16\uc2dc)', reply_markup=InlineKeyboardMarkup(buttons))\n"
    "        except:\n"
    ...
    "            buttons = [\n"
    "                [InlineKeyboardButton(f'{i}\uc2dc', callback_data=f'end_{i}') for i in range(13,17)],\n"
    "                [InlineKeyboardButton(f'{i}\uc2dc', callback_data=f'end_{i}') for i in range(17,21)],\n"
    "                [InlineKeyboardButton(f'{i}\uc2dc', callback_data=f'end_{i}') for i in range(21,25)],\n"
    "                [InlineKeyboardButton('25\uc2dc(\uc0c8\ubcbd 1\uc2dc)', callback_data='end_25')],\n"
    "            ]\n"
    "            await query.edit_message_text('\uadfc\ubb34 \uc885\ub8cc \uc2dc\uac01 \uc120\ud0dd (2\ud68c\ucc28: 13\uc2dc~25\uc2dc)', reply_markup=InlineKeyboardMarkup(buttons))\n"
